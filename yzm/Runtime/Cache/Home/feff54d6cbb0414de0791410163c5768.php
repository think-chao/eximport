...
<body>
<center>
    <form action='/yzm/index.php/Home/Add/add' method='post'>
        ...
        验证码<input type="text" name="code" placeholder="验证码"><br><br>
        <img src="<?php echo U('public/verify',array());?>"  onclick='this.src=this.src+"?"+Math.random()'>
        <br><br>
